        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-200 bg-slate-50/90">
          ...
          <div className="flex items-center gap-2">
            <button
              id="btn-guide-copy"
              onClick={handleCopy}
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-mono font-medium text-slate-700 bg-white hover:bg-slate-100 border border-slate-200 transition-colors shadow-2xs"
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-mono font-bold text-white bg-emerald-600 hover:bg-emerald-500 transition-all shadow-xs"
...
{`AI Inference (NVIDIA Jetson / Edge IPC) ──[1 Gbps Ethernet]──> Siemens S7-1500 / Allen-Bradley PLC
        ...
        <div className="flex items-center justify-between px-6 py-4 border-t border-slate-200 bg-slate-50/80">
          <div className="text-xs text-slate-500 font-mono flex items-center gap-2">
            ...
            <code className="bg-slate-200/80 px-1.5 py-0.5 rounded text-slate-800">/SYSTEM_GUIDE.md</code>
            <span>&bull;</span>
            <code className="bg-emerald-100 text-emerald-800 px-1.5 py-0.5 rounded font-bold">/SATISFY.md</code>
          </div>
          <div className="flex items-center gap-2">
            <button
              onClick={handleDownload}
              className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-mono font-bold text-emerald-700 bg-emerald-50 hover:bg-emerald-100 border border-emerald-300 rounded-xl shadow-xs transition-colors"
            >
              <Download className="w-3.5 h-3.5" />
            ...
            <button
              onClick={onClose}
              className="px-4 py-1.5 text-xs font-medium text-slate-700 hover:text-slate-900 bg-white hover:bg-slate-100 border border-slate-200 rounded-xl shadow-xs"
            >
              Close
            </button>
          </div>
